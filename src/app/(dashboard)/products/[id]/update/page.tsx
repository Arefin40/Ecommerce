      ...
      const fetchProduct = async () => {
         if (typeof id === "string") {
            ...
            if (product) {
               ...
               setValue("category", product[0].category);
               setValue("description", product[0].description);
               setValue("price", product[0].price);
               setValue("stock", product[0].stock);
               setPreviewImage(product[0].image || null);
               setAdditionalImages(product[0].images || []);
            }
         }
      };
      fetchProduct();
      ...
      try {
         ...
         if (typeof id === "string") {
            const response = await updateProduct(id, {
               ...values,
               image: values.image || previewImage || "",
               images: values.images || additionalImages
            });
